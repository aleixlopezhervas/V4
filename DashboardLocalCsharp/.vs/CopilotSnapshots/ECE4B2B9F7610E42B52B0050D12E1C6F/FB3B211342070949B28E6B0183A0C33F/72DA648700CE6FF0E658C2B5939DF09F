...
namespace Formulario
{
    public partial class Form1 : Form
    {
        ...
        private const double ARRIVAL_THRESHOLD = 0.000005;
        ...
        private const double WAYPOINT_ARRIVAL_THRESHOLD = 0.000005;
        ...
        private void ActualizarRutaEdicion()
        {
            ...
            if (instrucciones.Count >= 2)
            {
                var puntos = instrucciones.Select(i =>
                    new PointLatLng(i.Punto.Lat, i.Punto.Long)
                ).ToList();
        ...
        private async void BtnCargarRuta_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                MostrarSelectorVersiones(vueloSeleccionado);

                Instruccion.ReiniciarContador();
                var vueloCompleto = await droneAPIService.ObtenerVueloAsync(vueloSeleccionado.ID);
