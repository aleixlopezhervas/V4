...
namespace Formulario
{
    public partial class Form1 : Form
    {
        ...
        private DroneAPIService _droneAPIService;
        ...
        private void WaypointTimer_Tick(object sender, EventArgs e)
        {
            ...
            // Si el vuelo está pausado, saltar verificación de waypoint
            if (isFlightPaused)
                return;
        ...
        private async Task CargarWaypointsBD(string vueloId)
        {
            try
            {
                ...
                // Usar DroneAPIService para cargar la ruta
                var vuelo = await _droneAPIService.CargarRutaAsync(vueloId);
        ...
        private void pauseResumeBtn_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                // Pausar vuelo
                isFlightPaused = true;
                pauseResumeBtn.Text = "Reanudar Vuelo";
                pauseResumeBtn.BackColor = Color.Yellow;
                dron.Navegar("Stop");
                Console.WriteLine("Vuelo pausado en waypoint " + (currentWaypointIndex + 1));
            }
        }
